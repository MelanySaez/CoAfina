      ...
      <section className="relative px-6 pt-20 pb-32 lg:px-8 bg-gradient-to-br from-background via-background to-muted/30">
        <div className="absolute inset-0 -z-10">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1612965110667-4175024b0dcc?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1935')",
            }}
          />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center space-y-8">
            ...
            <p className="mx-auto max-w-3xl text-lg md:text-xl text-foreground/80 leading-relaxed">
              Plataforma de análisis y visualización de residuos de aparatos
              eléctricos y electrónicos (RAEE) en Latinoamérica. Empoderamos a
              investigadores, gobiernos y organizaciones con datos precisos para
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Link href="/workspace">
                <Button
                  size="lg"
                  className="text-lg px-8 py-6 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg hover:shadow-xl transition-all"
                >
                  Explorar Plataforma
                  <svg
              ...
              <Link
                href="https://github.com/MelanySaez/CoAfina"
                target="_blank"
              >
                <Button
                  size="lg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8 text-center bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/30 hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/20 scroll-reveal">
              ...
              <div className="text-sm text-muted-foreground">
                Datos de Latinoamérica con capacidad de importar CSVs
                personalizados
              </div>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 scroll-reveal-left">
              ...
              <p className="text-lg text-foreground/80 leading-relaxed">
                En E-Waste Analytics, creemos que los datos son la clave para
                resolver la crisis de los residuos electrónicos. Nuestra
                plataforma democratiza el acceso a información crítica sobre
                RAEE, permitiendo a investigadores, formuladores de políticas y
                organizaciones tomar decisiones informadas.
              </p>
              <p className="text-lg text-foreground/80 leading-relaxed">
                A través de visualizaciones interactivas, análisis comparativos
                y un repositorio de investigación actualizado, facilitamos la
                transición hacia una economía circular en Latinoamérica.
              </p>
            </div>
      ...
      <section className="px-6 py-20 lg:px-8 bg-card/30 border-y border-border/50">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto scroll-reveal">
            Herramientas poderosas diseñadas para investigadores y tomadores de
            decisiones
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-8 hover:shadow-xl transition-all border-2 hover:border-primary/50 scroll-reveal-scale">
              ...
              <p className="text-muted-foreground">
                Compara métricas de RAEE entre diferentes países con drag & drop
                intuitivo
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all border-2 hover:border-secondary/50 scroll-reveal-scale">
              ...
              <p className="text-muted-foreground">
                Gráficas interactivas con datos históricos y tendencias
                temporales
              </p>
            </Card>
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 border-2 border-primary/30 rounded-3xl p-12 shadow-2xl scroll-reveal-scale">
            ...
            <p className="text-lg text-foreground/80 mb-8 max-w-2xl mx-auto">
              Únete a investigadores, gobiernos y organizaciones que están
              usando E-Waste Analytics para impulsar la economía circular en
              Latinoamérica
            </p>
            <Link href="/workspace">
              <Button
                size="lg"
                className="text-lg px-10 py-7 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg hover:shadow-xl transition-all"
              >
                Comenzar Ahora
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-sm text-muted-foreground text-center">
              © 2025 E-Waste Analytics • Proyecto CoAfina Hackathon
              <br />
